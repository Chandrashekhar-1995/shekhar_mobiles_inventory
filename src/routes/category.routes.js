...
import { addSubcategory, createCategory, deleteCategory, fetchAllCategory, fetchCategoryByID, searchCategory, updateCategory } from "../controllers/category.controllers.js";

const categoryRouter = express.Router();

categoryRouter.post("/create", isLoggedIn, isUser, createCategory);
...
categoryRouter.post("/add-subcategory", isLoggedIn, isUser, addSubcategory);
